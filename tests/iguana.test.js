...
test('S12000038 - Renfrewshire', async () => await index.runTest('Renfrewshire'), 300000);
test('S12000026 - Scottish Borders', async () => await index.runTest('Scottish Borders'), 300000);
test('E06000021 - Stoke on Trent', async () => await index.runTest('Stoke on Trent'), 300000);
test('E10000031 - Warwickshire', async () => await index.runTest('Warwickshire'), 300000);
