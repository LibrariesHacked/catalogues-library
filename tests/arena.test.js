...
test('E06000011 - East Riding of Yorkshire', async () => await index.runTest('East Riding of Yorkshire'), 300000);
test('S12000036 - Edinburgh', async () => await index.runTest('Edinburgh'), 300000);
...
test('E06000016 - Leicester City', async () => await index.runTest('Leicester City'), 300000);
...
test('E06000003 - Redcar and Cleveland', async () => await index.runTest('Redcar and Cleveland'), 300000);
test('E06000051 - Shropshire', async () => await index.runTest('Shropshire'), 300000);
test('E06000020 - Telford and Wrekin', async () => await index.runTest('Telford and Wrekin'), 300000);
test('E06000027 - Torbay', async () => await index.runTest('Torbay'), 300000);
test('E10000032 - West Sussex', async () => await index.runTest('West Sussex'), 300000);
test('E06000054 - Wiltshire', async () => await index.runTest('Wiltshire'), 300000);
