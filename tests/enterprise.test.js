...
test('W06000001 - Sir Ynys Mon - Isle of Anglesey', async () => await index.runTest('Sir Ynys Mon - Isle of Anglesey'), 300000);
test('E09000002 - Barking and Dagenham', async () => await index.runTest('Barking and Dagenham'), 300000);
test('E08000016 - Barnsley', async () => await index.runTest('Barnsley'), 300000);
test('E06000022 - Bath and North East Somerset', async () => await index.runTest('Bath and North East Somerset'), 300000);
test('W06000019 - Blaenau Gwent', async () => await index.runTest('Blaenau Gwent'), 300000);
test('E08000032 - Bradford', async () => await index.runTest('Bradford'), 300000);
...
test('W06000008 - Sir Ceredigion - Ceredigion', async () => await index.runTest('Sir Ceredigion - Ceredigion'), 300000);
test('E09000001 - City of London', async () => await index.runTest('City of London'), 300000);
...
test('W06000004 - Sir Ddinbych - Denbighshire', async () => await index.runTest('Sir Ddinbych - Denbighshire'), 300000);
test('E06000015 - Derby City', async () => await index.runTest('Derby City'), 300000);
test('E10000007 - Derbyshire', async () => await index.runTest('Derbyshire'), 300000);
...
test('E09000018 - Hounslow', async () => await index.runTest('Hounslow'), 300000);
test('E09000020 - Kensington and Chelsea', async () => await index.runTest('Kensington and Chelsea'), 300000);
test('E09000021 - Kingston upon Thames', async () => await index.runTest('Kingston upon Thames'), 300000);
test('E08000034 - Kirklees', async () => await index.runTest('Kirklees'), 300000);
...
test('W06000022 - Casnewydd - Newport', async () => await index.runTest('Casnewydd - Newport'), 300000);
...
test('W06000016 - Rhondda Cynon Taf', async () => await index.runTest('Rhondda Cynon Taf'), 300000);
test('E08000018 - Rotherham', async () => await index.runTest('Rotherham'), 300000);
test('E06000017 - Rutland', async () => await index.runTest('Rutland'), 300000);
test('E08000019 - Sheffield', async () => await index.runTest('Sheffield'), 300000);
...
test('E09000030 - Tower Hamlets', async () => await index.runTest('Tower Hamlets'), 300000);
test('W06000014 - Bro Morgannwg - the Vale of Glamorgan', async () => await index.runTest('Bro Morgannwg - the Vale of Glamorgan'), 300000);
test('E08000036 - Wakefield', async () => await index.runTest('Wakefield'), 300000);
test('E09000031 - Waltham Forest', async () => await index.runTest('Waltham Forest'), 300000);
test('S12000039 - West Dunbartonshire', async () => await index.runTest('West Dunbartonshire'), 300000);
test('S12000040 - West Lothian', async () => await index.runTest('West Lothian'), 300000);
test('E09000033 - Westminster', async () => await index.runTest('Westminster'), 300000);
test('E10000034 - Worcestershire', async () => await index.runTest('Worcestershire'), 300000);
test('W06000006 - Wrecsam - Wrexham', async () => await index.runTest('Wrecsam - Wrexham'), 300000);
test('E06000014 - York City', async () => await index.runTest('York City'), 300000);
